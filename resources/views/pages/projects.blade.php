                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
                            ...
                            <div class="flex flex-col flex-1">
                                ...
                                <div class="p-5 flex flex-col flex-1">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-400 mb-4 text-sm leading-relaxed line-clamp-3">
                                        A digital platform to support the marketing and sales of BYD electric vehicles.
                                    </p>
                        ...
                        <div class="project-card group bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 overflow-hidden border border-gray-100 dark:border-gray-700 flex flex-col"
                            data-aos="fade-up" data-aos-delay="200" x-data="{
                                images: [
                                    '/storage/projects/capstone/1.png',
                                    '/storage/projects/capstone/2.png',
                                    '/storage/projects/capstone/3.png',
                                    '/storage/projects/capstone/4.png',
                                    '/storage/projects/capstone/5.png',
                                ],
                                currentImageIndex: 0,
                                showImageModal: false
                            }"
                            ...
                            <div class="flex flex-col flex-1">
                                <div class="relative overflow-hidden">
                                    ...
                                    <div class="h-48 overflow-hidden relative cursor-pointer"
                                        @click="showImageModal = true">
                                        {{-- Thumbnail menggunakan gambar index 0 --}}
                                        <img :src="images[0]" alt="Capstone - Bangkit Academy"
                                            class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                                ...
                                <div class="p-5 flex flex-col flex-1">
                                    ...
                                    <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2 line-clamp-2">
                                        Capstone - Bangkit Academy</h3>

                                    {{-- Project Description --}}
                                    <p class="text-gray-600 dark:text-gray-400 mb-4 text-sm leading-relaxed line-clamp-3">
                                        Development and integration of a mobile application with machine learning.
                                    </p>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <ul class="text-xs text-gray-600 dark:text-gray-400 space-y-1">
                                            <li class="flex items-start">
                                                ...
                                                <span class="line-clamp-2">High accuracy image classification with
                                                    81%+</span>
                                            </li>
                                            <li class="flex items-start">
                                                <svg class="w-3.5 h-3.5 text-purple-500 mr-1.5 mt-0.5 flex-shrink-0"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="flex flex-wrap gap-1.5">
                                            <span
                                                class="px-1.5 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs rounded-full">Tensorflow</span>
                                            <span
                                                class="px-1.5 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs rounded-full">Numpy</span>
                                            <span
                                                class="px-1.5 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs rounded-full">Keras</span>
                                            <span
                                                class="px-1.5 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs rounded-full">Matplotlib</span>
                                            <span
                                                class="px-1.5 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs rounded-full">Pandas</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-5 pt-0 mt-auto">
                                <div class="flex space-x-2">
                                    ...
                                    <a href="https://www.canva.com/design/DAGyfkJFbBU/xrRbyKG5lnpP3wqpAXhQkg/view?utm_content=DAGyfkJFbBU&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=hd659b455bd"
                                        target="_blank"
                                        class="flex-1 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white text-center text-sm font-medium py-2 px-3 rounded-xl transition-all duration-300 transform hover:-translate-y-1 shadow-md hover:shadow-lg flex items-center justify-center">
                                        <span>Live</span>
                                        <svg class="w-3.5 h-3.5 ml-1.5" fill="none" stroke="currentColor"
                        ...
                        {{-- Dashboard Job Tracker (Spreadsheet) --}}
                        <div class="project-card group bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 overflow-hidden border border-gray-100 dark:border-gray-700 flex flex-col"
                            data-aos="fade-up" data-aos-delay="100" x-data="{
                                images: [
                                    '/storage/projects/dashboard_spreadsheet/1.png',
                                    '/storage/projects/dashboard_spreadsheet/2.png',
                                    '/storage/projects/dashboard_spreadsheet/3.png',
                                    '/storage/projects/dashboard_spreadsheet/4.png',
                                    '/storage/projects/dashboard_spreadsheet/5.png',
                                    '/storage/projects/dashboard_spreadsheet/6.png',
                                    '/storage/projects/dashboard_spreadsheet/7.png',
                                ],
                                currentImageIndex: 0,
                                showImageModal: false
                            }"
                            ...
                            <div class="flex flex-col flex-1">
                                <div class="relative overflow-hidden">
                                    ...
                                    <div class="h-48 overflow-hidden relative cursor-pointer"
                                        @click="showImageModal = true">
                                        {{-- Thumbnail menggunakan gambar index 0 --}}
                                        <img :src="images[0]" alt="Dashboard Job Tracker"
                                            class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                                ...
                                <div class="p-5 flex flex-col flex-1">
                                    {{-- Project Title --}}
                                    <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2 line-clamp-2">
                                        Dashboard Job Tracker (Google Sheet)</h3>

                                    {{-- Project Description --}}
                                    <p class="text-gray-600 dark:text-gray-400 mb-4 text-sm leading-relaxed line-clamp-3">
                                        Design and implementation of a dynamic spreadsheet-based Job Tracker dashboard.
                                    </p>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <ul class="text-xs text-gray-600 dark:text-gray-400 space-y-1">
                                            <li class="flex items-start">
                                                ...
                                                <span class="line-clamp-2">Monthly Financial Summary</span>
                                            </li>
                                            <li class="flex items-start">
                                                <svg class="w-3.5 h-3.5 text-green-500 mr-1.5 mt-0.5 flex-shrink-0"
                                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <span class="line-clamp-2">Customer & Team Performance Trends</span>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="flex flex-wrap gap-1.5">
                                            <span
                                                class="px-1.5 py-0.5 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-xs rounded-full">Google
                                                Sheet</span>
                                            <span
                                                class="px-1.5 py-0.5 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-xs rounded-full">SQL</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-5 pt-0 mt-auto">
                                <button @click="showImageModal = true"
                                    class="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white text-center text-sm font-medium py-2 px-3 rounded-xl transition-all duration-300 transform hover:-translate-y-1 shadow-md hover:shadow-lg flex items-center justify-center">
                                    <svg class="w-3.5 h-3.5 mr-1.5" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="project-card group bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 overflow-hidden border border-gray-100 dark:border-gray-700 flex flex-col"
                            data-aos="fade-up" data-aos-delay="100" x-data="{
                                images: [
                                    '/storage/projects/sentimen_analysis/1.png',
                                    '/storage/projects/sentimen_analysis/2.png',
                                    '/storage/projects/sentimen_analysis/3.png',
                                    '/storage/projects/sentimen_analysis/4.png',
                                    '/storage/projects/sentimen_analysis/5.png',
                                    '/storage/projects/sentimen_analysis/6.png',
                                    '/storage/projects/sentimen_analysis/7.png',
                                    '/storage/projects/sentimen_analysis/8.png',
                                ],
                                currentImageIndex: 0,
                                showImageModal: false
                            }"
                            ...
                            <div class="flex flex-col flex-1">
                                ...
                                <div class="p-5 flex flex-col flex-1">
                                    {{-- Project Title --}}
                                    <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2 line-clamp-2">
                                        Sentimen Analysis - Shopee</h3>

                                    {{-- Project Description --}}
                                    <p class="text-gray-600 dark:text-gray-400 mb-4 text-sm leading-relaxed line-clamp-3">
                                        End-to-end sentiment analysis pipeline development using Google Play Scraper.
                                    </p>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <ul class="text-xs text-gray-600 dark:text-gray-400 space-y-1">
                                            <li class="flex items-start">
                                                ...
                                                <span class="line-clamp-2">Automated Data Collection</span>
                                            </li>
                                            <li class="flex items-start">
                                                <svg class="w-3.5 h-3.5 text-blue-500 mr-1.5 mt-0.5 flex-shrink-0"
                                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <span class="line-clamp-2">Multi-Model Experimentation</span>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="flex flex-wrap gap-1.5">
                                            <span
                                                class="px-1.5 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs rounded-full">Google
                                                Play Scraper</span>
                                            <span
                                                class="px-1.5 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs rounded-full">Numpy</span>
                                            <span
                                                class="px-1.5 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs rounded-full">Tensorflow</span>
                                            <span
                                                class="px-1.5 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs rounded-full">Keras</span>
                                            <span
                                                class="px-1.5 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs rounded-full">Seaborn</span>
                                            <span
                                                class="px-1.5 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs rounded-full">Pandas</span>
                                            <span
                                                class="px-1.5 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs rounded-full">Scikit-Learn</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
